...
class AssignmentAdmin(admin.ModelAdmin):
    list_display = ('id', 'course', 'name', 'folder', 'creator', 'description', 'created_at', 'filename', 'valid_from', 'expires_at', 'can_studentsubmit', 'remove_collected', 'max_number_of_files', 'max_size')
