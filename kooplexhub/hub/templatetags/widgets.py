...
<div data-type="text" data-title="Edit {instance_type} name" data-id="{instance_id(instance)}" data-field="name" data-orig="{orig}" 
...
<div role="button">
    <p class="card-text editable"
       data-type="textarea" data-id="{instance_id(instance)}" data-title="Edit {instance_type} description"
